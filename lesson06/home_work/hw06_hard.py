...
class workers_class:
    ...
    def get_full_info(self):
        return print(f"Сотрудник  {self.name:<9} {self.surname:<10}:  {int(self.wage):> 8} руб.")
...
workers = open('data\workers', 'r', encoding="utf-8")
hours = open('data\hours_of', 'r', encoding="utf-8")
